            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                ...
                <div className="space-y-1.5">
                  <label className="block text-right text-xs font-bold text-[#2A4365]">
                    اسم المستخدم
                  </label>
                  <div 
                  ...
                  >
                    ...
                    <User className="w-4 h-4 text-[#2A4365] shrink-0" />
                    {/* Input field */}
                    <input
                      type="text"
                      maxLength={14}
                      ...
                      className="flex-1 h-full bg-transparent border-none outline-none text-[#0B2E59] text-sm font-mono tracking-wider text-right pr-2 placeholder:text-slate-400 font-bold"
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    ...
                    <Lock className="w-4 h-4 text-[#2A4365] shrink-0" />
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="flex-1 h-full bg-transparent border-none outline-none text-[#0B2E59] text-sm font-mono tracking-wider text-right px-2 placeholder:text-slate-400 font-bold"
                    ...
                    <button
                      ...
                      className="text-[#2A4365] hover:text-[#0B2E59] p-1 transition-colors shrink-0 cursor-pointer"
                ...
                <div className="flex items-center justify-end pt-0.5">
                  <label className="flex items-center gap-2 cursor-pointer select-none text-xs text-[#2A4365] font-bold">
                    <span>تذكرني</span>
                    <div
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-[50px] rounded-[14px] text-white font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed transform hover:-translate-y-0.5 active:translate-y-0"
                  style={{
                ...
                <div className="pt-3 flex items-center justify-center">
                  <div className="w-full flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="text-xs text-[#0078D4] hover:text-[#106EBE] hover:underline font-bold whitespace-nowrap transition-colors cursor-pointer"
                    >
                      هل نسيت كلمة المرور؟
                    </button>
                    <div className="flex-1 h-px bg-slate-300/60" />
